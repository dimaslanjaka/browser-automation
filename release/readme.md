# Release `browser-automation` tarball
## Releases
| version | tarball url |
| :--- | :--- |
...
| latest | https://github.com/dimaslanjaka/browser-automation/raw/1d0caf5/release/browser-automation.tgz |
...
{
  "resolutions": {
    "browser-automation": "<url of tarball>"
  }
}
```
...
## Get URL of `browser-automation` Release Tarball
- select tarball file
