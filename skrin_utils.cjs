...
var date_js = require('../src/date.js');
...
async function fixTbAndBb(page, age, gender) {
  ...
  if (!tbValue) {
    ...
    if (tinggiBadan) {
      await puppeteer_utils_js.typeAndTrigger(page, "#field_item_tinggi_badan input", tinggiBadan.toString());
    } else {
  ...
  if (!bbValue) {
    ...
    if (beratBadan) {
      await puppeteer_utils_js.typeAndTrigger(page, "#field_item_berat_badan input", beratBadan.toString());
    } else {
...
async function getPersonInfo(page) {
  ...
  const age = date_js.getAge(birthDate);
...
exports.confirmIdentityModal = confirmIdentityModal;
exports.fixTbAndBb = fixTbAndBb;
exports.getBeratBadan = getBeratBadan;
exports.getPersonInfo = getPersonInfo;
exports.getTinggiBadan = getTinggiBadan;
exports.isIdentityModalVisible = isIdentityModalVisible;
exports.isInvalidAlertVisible = isInvalidAlertVisible;
exports.isNIKNotFoundModalVisible = isNIKNotFoundModalVisible;
exports.isNikErrorVisible = isNikErrorVisible;
exports.isSuccessNotificationVisible = isSuccessNotificationVisible;
//# sourceMappingURL=skrin_utils.cjs.map
//# sourceMappingURL=skrin_utils.cjs.map