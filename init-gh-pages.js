...
function initGitRepository() {
    ...
    try {
        ...
        try {
            ...
            execSync('git remote set-url origin https://github.com/dimaslanjaka/browser-automation.git', { stdio: 'inherit' });
        }
...
if (process.argv[1] && import.meta.url === `file:///${process.argv[1].replace(/\\/g, '/').replace(/^[A-Z]:/, (match) => match.toLowerCase())}`) {
    initGitRepository();
}
