import { SharedPreferences, getChecksum } from 'sbg-utility';
import fs from 'fs-extra';
import path from 'upath';
import { MysqlLogDatabase } from './MysqlLogDatabase.mjs';
import { getDatabaseFilePath, SQLiteLogDatabase } from './SQLiteLogDatabase.mjs';
import isDebug from '../../_virtual/isDebug.mjs';
