...
import { isEmpty, array_unique } from 'sbg-utility';
import { fileURLToPath } from 'url';
import { PuppeteerCookies as Cookies } from './puppeteer/Cookies.mjs';
import { getRandomCachedFingerprint, fetchAndSaveFingerprintToCache, getLatestCachedFingerprint } from './puppeteer/fingerprint_utils.mjs';
import { extractFormValues } from './puppeteer/getFormValuesFromFrame.mjs';
export { getFormValuesFromFrame } from './puppeteer/getFormValuesFromFrame.mjs';
import goWithRetry from './puppeteer/goWithRetry.mjs';
import { GLOBAL_PROFILES_DIR, launchWithProfileFallback } from './puppeteer/profile-manager.mjs';
export { getFallbackProfileDir } from './puppeteer/profile-manager.mjs';
import { sleep } from './utils/browser.mjs';
 ...
 */
const userDataDir = path.join(GLOBAL_PROFILES_DIR, 'profile1');
/**
...
export { closeOtherTabs, getFormValues, getPuppeteer, isElementExist, isElementVisible, maximizeWindow, pageScreenshot, typeAndTrigger, userDataDir, waitForDomStable };
