...
import { closeOtherTabs, typeAndTrigger, maximizeWindow, pageScreenshot } from '../../puppeteer_utils.mjs';
import { createSkrinDatabase } from '../../database/shared.mjs';
import { autoLoginAndEnterSkriningPage } from '../../skrin_puppeteer.mjs';
import { getNumbersOnly, sleep } from '../../utils/browser.mjs';
import { imageFileToDataUrl, openImageExternally } from '../../utils/image.mjs';
import { decryptJson, encryptJson } from '../../utils/json-crypto.mjs';
import md5 from '../../utils/md5.mjs';
import { isValidNik } from '../../utils/xlsx/fixData.mjs';
import { EndpointManager } from '../../../puppeteer/parallel/EndpointManager.mjs';

const IMAGE_DATABASE_PATH = 'tmp/screenshot/metadata.bin';
const IMAGE_DATABASE = fs.existsSync(IMAGE_DATABASE_PATH)
...
export { getParallelSkrinCheckClaimedEndpoint, parallelSkrinCheck, parallelSkrinCheckEndpointManager };
