...
import { toNumber } from '../utils/number.mjs';
...
export { fetchAndSaveFingerprintToCache, getFingerprintCacheDir, getLatestCachedFingerprint, getRandomCachedFingerprint, listCachedFingerprintFiles, parseScreenSize, saveFingerprintToCache };
