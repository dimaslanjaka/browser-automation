...
import require$$2 from 'nik-parser-jurusid';
import path from 'node:path';
import require$$4 from 'sbg-utility';
...
function requireLogs () {
	...
	function logInline(...args) {
	    ...
	    commonjsGlobal.__lastLogWasInline = true;
	}
	/**
	...
	function logLine(...args) {
	    ...
	    const prefix = commonjsGlobal.__lastLogWasInline ? '\n' : '';
	    process.stdout.write(`${prefix}${output}\n`);
	    commonjsGlobal.__lastLogWasInline = false;
	}
	logs = { logLine, logInline, getLogData, appendLog, defaultLogFilePath };
	return logs;
}

export { requireLogs as __require };
