...
const DEFAULT_CACHE_DIR = path.join(process.cwd(), 'tmp/fixdata-cache', db_utils.toValidMySQLDatabaseName(process.env.MYSQL_DBNAME || process.env.DATABASE_FILENAME || 'default'));
/**
...
exports.FixDataCache = FixDataCache;
