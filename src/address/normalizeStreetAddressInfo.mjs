...
function normalizeStreetAddressInfo(result, provider) {
    ...
    const kecamatan = pickValue(address.city_district, address.subdistrict, address.district, address.county, address.municipality);
...
export { normalizeStreetAddressInfo };
