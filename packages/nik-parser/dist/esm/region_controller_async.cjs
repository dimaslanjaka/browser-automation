...
async function getPropinsi(kode) {
    const provinces = (await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespaceDefaultOnly(require('./data/provinces.cjs')); })).default;
...
async function getKokab(kode) {
    const regencies = (await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespaceDefaultOnly(require('./data/regencies.cjs')); })).default;
...
async function getKec(kode) {
    const districts = (await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespaceDefaultOnly(require('./data/districts.cjs')); })).default;
...
async function getKel(kode) {
    const villages = (await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespaceDefaultOnly(require('./data/villages.cjs')); })).default;
    const data = [];
    villages.find((o, i) => {
...
exports.getKec = getKec;
exports.getKel = getKel;
exports.getKokab = getKokab;
exports.getPropinsi = getPropinsi;
exports.guessKelurahanByUniqcode = guessKelurahanByUniqcode;
exports.nikParser = nikParser;
exports.nikparse = nikParser;
