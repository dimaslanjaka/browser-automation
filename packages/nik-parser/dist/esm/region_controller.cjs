...
var provinces = require('./data/provinces.cjs');
var regencies = require('./data/regencies.cjs');
var districts = require('./data/districts.cjs');
var villages = require('./data/villages.cjs');
...
exports.default = nikParserSync;
exports.getKecSync = getKecSync;
exports.getKelSync = getKelSync;
exports.getKokabSync = getKokabSync;
exports.getPropinsiSync = getPropinsiSync;
exports.guessKelurahanByUniqcodeSync = guessKelurahanByUniqcodeSync;
exports.nikParserSync = nikParserSync;
exports.nikparse = nikParserSync;
