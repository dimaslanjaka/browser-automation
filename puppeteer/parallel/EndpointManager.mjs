import { jsonParseWithCircularRefs, writefile, jsonStringifyWithCircularRefs } from 'sbg-utility';
import path from 'upath';
import fs from 'fs-extra';
import puppeteer from 'puppeteer-extra';
import { GLOBAL_PUPPETEER_DIR } from '../../src/puppeteer/profile-manager.mjs';

/**
 * Global shared directory for endpoint data, nested under {@link GLOBAL_PUPPETEER_DIR}.
 */
const GLOBAL_ENDPOINT_MANAGER_PATH = path.join(GLOBAL_PUPPETEER_DIR, 'endpoints');
