...
const __filename$1 = url.fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('puppeteer_utils.cjs', document.baseURI).href)));
path__default.default.dirname(__filename$1);
const userDataDir = path__default.default.resolve(process.cwd(), ".cache/profile1");
...
async function getPuppeteer(options = {}) {
  ...
  if (!puppeteer_browser || !puppeteer_browser.connected || !merged.reuse) {
    if (merged.executablePath && !fs__default.default.existsSync(merged.executablePath)) {
      merged.executablePath = void 0;
    }
    puppeteer_browser = await puppeteer__default.default.launch(merged);
  }
  const page = await puppeteer_browser.newPage();
  return { page, browser: puppeteer_browser, puppeteer: puppeteer__default.default };
}
async function getPlaywright(options = {}) {
  ...
  if (!playwright_browser || !playwright_browser.isConnected() || !merged.reuse) {
    ...
    playwright_browser = await playwrightExtra.chromium.launch(merged);
  }
  const page = await playwright_browser.newPage();
  const context = await page.context();
  return { page, browser: playwright_browser, context, playwright: playwrightExtra.chromium };
}
...
async function typeAndTrigger(page, selector, value) {
  ...
  await utilsBrowser_js.sleep(300);
}
...
async function validateAndRetryIframeInput(page, iframeSelector, elementSelector, expectedValue, options = {}) {
  ...
  for (let attempt = 0; attempt <= maxRetries; attempt++) {
    ...
    if (attempt < maxRetries) {
      ...
      await utilsBrowser_js.sleep(retryDelay);
    }
  }
...
async function closeFirstTab(context) {
  if (context instanceof puppeteer$1.Page) {
    const browser = context.browser();
    const pages = await browser.pages();
    if (pages.length > 1) {
      await pages[0].close();
    }
  } else if (context instanceof puppeteer$1.Browser) {
...
exports.anyElementWithTextExists = anyElementWithTextExists;
exports.clearCurrentPageCookies = clearCurrentPageCookies;
exports.clickElementByText = clickElementByText;
exports.clickIframeElement = clickIframeElement;
exports.closeFirstTab = closeFirstTab;
exports.closePuppeteer = closePuppeteer;
exports.elementExists = elementExists;
exports.elementWithTextExists = elementWithTextExists;
exports.elementsContainText = elementsContainText;
exports.getFormValues = getFormValues;
exports.getFormValuesFromFrame = getFormValuesFromFrame;
exports.getPlaywright = getPlaywright;
exports.getPuppeteer = getPuppeteer;
exports.isElementExist = isElementExist;
exports.isElementVisible = isElementVisible;
exports.isIframeElementVisible = isIframeElementVisible;
exports.setIframeElementValue = setIframeElementValue;
exports.triggerInputChange = triggerInputChange;
exports.typeAndTrigger = typeAndTrigger;
exports.typeAndTriggerIframe = typeAndTriggerIframe;
exports.typeToIframe = typeToIframe;
exports.validateAndRetryIframeInput = validateAndRetryIframeInput;
exports.waitForDomStable = waitForDomStable;
exports.waitForDomStableIndefinite = waitForDomStableIndefinite;
//# sourceMappingURL=puppeteer_utils.cjs.map
//# sourceMappingURL=puppeteer_utils.cjs.map