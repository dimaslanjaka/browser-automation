...
function loadJS(url, props) {
  ...
  return new Bluebird__default.default((resolve, reject) => {
    var _a;
...
exports.extractNumericWithComma = extractNumericWithComma;
exports.getNumbersOnly = getNumbersOnly;
exports.getWeekdaysOfCurrentMonth = getWeekdaysOfCurrentMonth;
exports.loadJS = loadJS;
exports.noop = noop;
exports.randomStr = randomStr;
exports.sleep = sleep;
exports.stripProtocol = stripProtocol;
exports.uniqueArrayObjByKey = uniqueArrayObjByKey;
//# sourceMappingURL=utils-browser.cjs.map
//# sourceMappingURL=utils-browser.cjs.map